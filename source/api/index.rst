...
|                   名称                   |           功能说明           |
+==========================================+==============================+
| :func:`wx.stopBackgroundAudio`           | 停止播放音乐                 |
+------------------------------------------+------------------------------+
| :func:`wx.seekBackgroundAudio`           | 控制音乐播放进度             |
+------------------------------------------+------------------------------+
| :func:`wx.playBackgroundAudio`           | 使用后台播放器播放音乐       |
+------------------------------------------+------------------------------+
| :func:`wx.pauseBackgroundAudio`          | 暂停播放音乐                 |
+------------------------------------------+------------------------------+
| :func:`wx.onBackgroundAudioStop`         | 监听音乐停止事件             |
+------------------------------------------+------------------------------+
| :func:`wx.onBackgroundAudioPlay`         | 监听音乐播放事件             |
+------------------------------------------+------------------------------+
| :func:`wx.onBackgroundAudioPause`        | 监听音乐暂停事件             |
+------------------------------------------+------------------------------+
| :func:`wx.getBackgroundAudioPlayerState` | 获取后台音乐播放状态         |
+------------------------------------------+------------------------------+
