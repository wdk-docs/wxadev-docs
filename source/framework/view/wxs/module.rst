...
在微信开发者工具里面，``右键`` 可以直接创建 ``.wxs`` 文件，在其中直接编写 WXS 脚本。
...
:download:`在开发者工具中预览效果 <https://developers.weixin.qq.com/s/KYgu1Km36pZP>`
...
:download:`在开发者工具中预览效果 <https://developers.weixin.qq.com/s/E4g94Kme6rZ6>`
...
有重复模块名则按照先后顺序覆盖（后者覆盖前者）。不同文件之间的 wxs 模块名不会相互覆盖。
...
:download:`在开发者工具中预览效果 <https://developers.weixin.qq.com/s/IzgmKKmn6tZ6>`
...
:download:`在开发者工具中预览效果 <https://developers.weixin.qq.com/s/C7gYFKmh6vZI>`
