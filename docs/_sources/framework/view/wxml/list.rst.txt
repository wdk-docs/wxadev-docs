...
:wxfrwk:`wx:for 列表渲染 <view/wxml/list>`
======================================

.. _wx-for:


- ``wx:for`` ``wx:for-item`` ``wx:for-index`` ``wx:key="*this"``
...
:download:`在开发者工具中预览效果 <https://developers.weixin.qq.com/s/tpg5tKmv6kZt>`
...
.. tip:: 当 wx:for 的值为字符串时，会将字符串解析成字符串数组
