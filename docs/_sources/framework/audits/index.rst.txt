...
3. 点击”开始“按钮，然后自行操作小程序界面，运行过的页面就会被“体验评分”检测到。
   ...
   .. image:: https://res.wx.qq.com/wxdoc/dist/assets/img/start.8773023b.png
...
5. 如需再次运行体验评分，可点击报告上方的“清空体验评分”恢复初始状态。请注意，目前系统不提供报告存储服务，一旦清空体验评分，将无法再查看本次评分结果。
   ...
   .. image:: https://res.wx.qq.com/wxdoc/dist/assets/img/finish.5fb85a1d.png
...
.. image:: https://res.wx.qq.com/wxdoc/dist/assets/img/autorun.80170928.png
   :alt: autorun
