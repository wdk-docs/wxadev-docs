...
:wxref:`场景值列表 <scene-list>`
================================

关于场景值的详细说明和获取方式请参考 指南 - :ref:`app-service_scene`
...
| 1103     | 发现栏小程序主入口，                                  |      |
+----------+-------------------------------------------------------+------+
|          | 「我的小程序」列表（基础库2.2.4版本起废弃）           | /    |
+----------+-------------------------------------------------------+------+
| 1104     | 微信聊天主界面下拉，                                  |      |
+----------+-------------------------------------------------------+------+
|          | 「我的小程序」栏（基础库2.2.4版本起废弃）             | /    |
+----------+-------------------------------------------------------+------+
| 1129     | 微信爬虫访问 详情                                     | /    |
+----------+-------------------------------------------------------+------+
