:wxref:`页面配置 <configuration/page>`
===========================================

每一个小程序页面也可以使用 ``.json`` 文件来对本页面的窗口表现进行配置。
页面中配置项在当前页面会覆盖 :file:`app.json` 的 :envvar:`window` 中相同的配置项。
...
页面配置中只能设置 :file:`app.json` 中 :envvar:`window` 对应的配置项，
以决定本页面的窗口表现，所以无需写 :envvar:`window` 这个属性。
