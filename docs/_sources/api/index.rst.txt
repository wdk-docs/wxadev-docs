...
|          名称           |                             功能说明                              |
+=========================+===================================================================+
| :func:`wx.pluginLogin`  | 该接口仅在小程序插件中可调用,调用接口获得插件用户标志凭证（code） |
+-------------------------+-------------------------------------------------------------------+
...
.. toctree::
   ...
   ./login/wx.pluginLogin
   ./login/wx.login
   ./login/wx.checkSession
...
|                名称                |                         功能说明                         |
+====================================+==========================================================+
| :func:`wx.requestSubscribeMessage` | 调起客户端小程序订阅消息界面，返回用户订阅消息的操作结果 |
+------------------------------------+----------------------------------------------------------+
...
|           名称            |       功能说明       |
+===========================+======================+
| :func:`wx.showRedPackage` | 拉取h5领取红包封面页 |
+---------------------------+----------------------+
...
|              名称              | 功能说明 |
+================================+==========+
| :func:`wx.addVideoToFavorites` | 收藏视频 |
+--------------------------------+----------+
| :func:`wx.addFileToFavorites`  | 收藏文件 |
+--------------------------------+----------+
